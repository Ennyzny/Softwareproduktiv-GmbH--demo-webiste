...
export default function OwnDevelopments() {
  return (
    <section
      ...
      className="leading-normal box-border bg-(--dark) relative text-white m-0 p-0"
    >
      <div className="leading-normal text-white box-border max-w-(--maxw) text-center relative z-1 mx-auto my-0 px-0 py-16">
        ...
        <button
          ...
          className="inline-flex cursor-pointer items-center gap-2.5 border-[1.5px] border-white/60 bg-transparent px-6.5 py-3.25 text-[13px] font-bold uppercase tracking-[0.08em] text-white transition-all duration-200 hover:border-white hover:bg-white hover:text-(--primary) hover:-translate-y-px"
        >
          Leistungen
        </button>
      </div>
