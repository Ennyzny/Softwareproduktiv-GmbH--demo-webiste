export default function OurPrinciple() {
  return (
    <section id="unser-grundsatz" className="text-center py-32.5">
      <div className="max-w-310 mx-auto px-5 sm:px-10 reveal">
        <span className="inline-block text-[13px] font-bold uppercase tracking-[.14em] text-(--accent) mb-5">
          // Unser Grundsatz
        </span>
        <h2 className="text-(--primary) text-(length:--fs-display) font-medium leading-[1.22] tracking-[-0.01em]">
