    ...
    >
      <div className="mx-auto max-w-310 px-10 max-sm:px-5">
        ...
        <div className="grid grid-cols-3 gap-6.5 max-[900px]:grid-cols-2 max-[600px]:grid-cols-1">
          <div className="group relative flex min-h-[308px] flex-col bg-white px-[34px] pt-10 pb-[34px] before:absolute before:left-0 before:top-0 before:h-[3px] before:w-[60px] before:bg-(--violet) before:transition-all before:duration-300 hover:before:w-full">
            ...
            <span className="mt-auto inline-flex items-center gap-[11px] text-[14px] font-bold text-(--accent)">
              <span className="flex h-5 w-5 items-center justify-center rounded-full bg-(--primary)">
                <span className="h-[2px] w-[9px] rounded bg-white"></span>
              </span>
              Excel-Chaos
            </span>
          </div>
