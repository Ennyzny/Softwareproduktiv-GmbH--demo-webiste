export default function Philosophy() {
  return (
   <section id="philosophie" className="bg-(--background) py-[120px] max-[768px]:py-[70px]">
      <div className="mx-auto flex max-w-310 flex-col gap-8 px-10 max-[640px]:px-5 min-[900px]:flex-row min-[900px]:gap-[70px]">
